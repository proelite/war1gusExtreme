...
DefineButton( { Pos = 2, Level = 0, Icon = "icon-human-shield2",
  ...
  Key = "s", Hint = "~!STOP",
  ForUnit = {"unit-footman", "unit-archer", "unit-human-sapper",
    "unit-knight",
    "unit-human-catapult"}} )
...
DefineButton( { Pos = 5, Level = 2, Icon = "icon-human-siege-workshop",
...
DefineButton( { Pos = 5, Level = 0, Icon = "icon-human-sapper",
  Action = "train-unit", Value = "unit-human-sapper",
  Key = "a", Hint = "TRAIN S~!APPER",
...
DefineButton( { Pos = 3, Level = 0, Icon = "icon-human-sapper",
  Action = "train-unit", Value = "unit-human-sapper",
